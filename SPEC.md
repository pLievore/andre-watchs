...
| D23 | Boomerang no vídeo do mobile | O vídeo vai até o fim e volta no tempo, em vez de cortar seco pro início — o corte é o instante em que o olho percebe o loop. Ida e volta ficam no mesmo arquivo (24s, 6,7 MB), porque `playbackRate = -1` não funciona no iOS. | 2026-08-21 |
